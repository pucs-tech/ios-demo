...
@interface UIView_PUCsAdView : UIView <WKScriptMessageHandler, WKNavigationDelegate> {
...
//-(void)initializePucsWithClientID:(NSString *)clientID onAVPlayerViewController:(AVPlayerViewController *)parentPlayerController;
//-(void)playAdsWithOptions:(NSDictionary *)options withFailureBlock:(void(^)(NSError *error))failure;
